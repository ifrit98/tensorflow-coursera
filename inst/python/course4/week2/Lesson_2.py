...
hist = model.fit(dataset, epochs=100, verbose=0, callbacks=[lr_schedule])


# loss per epoch with LR scheduler
...
model.compile(loss="mse", optimizer=optimizer)
hist = model.fit(dataset, epochs=EPOCHS, verbose=0, callbacks=[lr_schedule])
